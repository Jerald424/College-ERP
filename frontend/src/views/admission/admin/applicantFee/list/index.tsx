...
export default function AdminApplicantFee() {
  ...
  return (
    <div>
      <CardCmp
        title={
          <div>
            <span className="me-3">Applicant Fee</span>
            <Link to={"detail"}>
      ...
      <Modal description="To delete application fee" okButtonProps={{ onClick: handleDelete }} />
    </div>
  );
}
