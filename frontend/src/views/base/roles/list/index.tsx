...
export default function RolesList() {
  const { columns, isLoading, dataSource, pagination, setPagination, total_count, selected, Modal, setIsOpen, handleDelete } = useList();
  return (
    <CardCmp
      title={
        <div>
    ...
    >
      ...
      />
      <Modal description="To delete role" okButtonProps={{ onClick: handleDelete }} />
    </CardCmp>
  );
}
