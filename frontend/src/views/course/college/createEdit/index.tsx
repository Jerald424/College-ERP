...
export default function AdminCourseCreateEdit() {
  const { control, form_data, record_id, Modal, handleSubmit, navigate, isLoading, onSubmit, isEdit, setIsEdit } = useCreate();
  return (
    <div>
      <Breadcrumb className="ms-3 mb-2" items={[{ title: "Course", path: "/divider/course/admin/list" }, { title: record_id ? "Update" : "Create" }]} />
      ...
      <AuditLog record_id={record_id} table_names={["course", "course_term", "course_programme", "course_staff"]} />
