...
export default function TransportBusScheduledList() {
  ...
  return (
    <div>
      <CardCmp
        title={
          <div>
            <span className="me-3">Bus schedule</span>
            <Link to={"detail"}>
      ...
      <Modal description="To delete bus schedule" okButtonProps={{ onClick: handleDelete }} />
    </div>
  );
}
