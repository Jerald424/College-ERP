...
export default function TransportBusSessionList() {
  ...
  return (
    <div>
      <CardCmp
        title={
          <div>
            <span className="me-3">Bus session</span>
            <Link to={"detail"}>
      ...
      <Modal description="To delete bus session" okButtonProps={{ onClick: handleDelete }} />
    </div>
  );
}
